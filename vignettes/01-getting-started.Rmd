...
Next, set your git credentials, if you have not already done this. Github no longer supports password authentication for git operations. You will need to create a personal access token (PAT) to use in place of your password for git operations.
